...
#include "/home/guanqin/compareM/Marabou/src/basis_factorization/tests/Test_SparseLUFactors.h"

static SparseLUFactorsTestSuite suite_SparseLUFactorsTestSuite;

static CxxTest::List Tests_SparseLUFactorsTestSuite = { 0, 0 };
CxxTest::StaticSuiteDescription suiteDescription_SparseLUFactorsTestSuite( "/home/guanqin/compareM/Marabou/src/basis_factorization/tests/Test_SparseLUFactors.h", 27, "SparseLUFactorsTestSuite", suite_SparseLUFactorsTestSuite, Tests_SparseLUFactorsTestSuite );
